...
export default {
  ...
  actions: {
    ...
    invokeSignupFunction(store, JWT) {
      return new Promise((resolve, reject) => {
        ...
        fetch(URL, {
          ...
          .catch((error) => {
            reject(
              new Error('Something wrong with invoke signupFunction', error)
            )
          })
      })
    },
    ...
    initAuth({ commit }) {
      ...
      console.log('Initialising Go True client with ', newGoTrue)
      commit('SET_GOTRUE', newGoTrue)
    },
      ...
      return new Promise((resolve, reject) => {
        state.GoTrueAuth.recover(token)
          ...
          .catch((error) => {
            ...
            reject(
              new Error('Something wrong with attemptPasswordRecovery', error)
            )
          })
      })
    },
